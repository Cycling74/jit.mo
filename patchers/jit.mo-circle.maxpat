...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 158.5, 237.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.5, 292.0, 205.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.material @mat_specular 0 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 76.0, 237.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "jit.mo.slice -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 81.0, 121.0, 22.0 ],
					"style" : "",
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 142.0, 143.0, 126.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 76.0, 143.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "jit.mo.sin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 76.0, 188.0, 151.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.0, 257.0, 122.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 0.1 0.1 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 385.0, 292.0, 115.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.0, 333.0, 328.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.multiple 2 @glparams position scale @position 0 0 -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 76.0, 369.0, 165.0, 22.0 ],
					"style" : "",
